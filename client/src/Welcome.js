        ...
        <section className="welcome__main">
            <div className="main__content">
                ...
                <div className="main__before-starting">
                    <p>
                        This is the the homepage of the <b>Client App</b>, you can switch to{' '}
                        {'http:' === document.location.protocol ? <a href={`https://${document.domain}`}>HTTPS</a> : <a href={`http://${document.domain}`}>HTTP</a>} version.
                    </p>
                    <p>
                        Browse the list of available <Link to="projects/">projects</Link>
                    </p>
                </div>
